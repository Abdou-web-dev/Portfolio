...
const btn_accordion1 = document.querySelector("#projects .accordion-button1")
const btn_accordion2 = document.querySelector("#projects .accordion-button2")
...
//mini projects
const word_technologies = document.querySelector("#projects .word-technologies") // 16 letters , children
const card1 = document.querySelector("#projects .card1")
const card1_img1 = document.querySelector("#projects .card1_img1")
const card1_img2 = document.querySelector("#projects .card1_img2")
const card1_img3 = document.querySelector("#projects .card1_img3")
//card2
const word_technologies2 = document.querySelector("#projects .word-technologies2") // 16 letters , children
const card2 = document.querySelector("#projects .card2")
const card2_img1 = document.querySelector("#projects .card2_img1")
const card2_img2 = document.querySelector("#projects .card2_img2")
const card2_img3 = document.querySelector("#projects .card2_img3")

//card3
const word_technologies3 = document.querySelector("#projects .word-technologies3") // 16 letters , children
const card3 = document.querySelector("#projects .card3")
const card3_img1 = document.querySelector("#projects .card3_img1")
const card3_img2 = document.querySelector("#projects .card3_img2")
const card3_img3 = document.querySelector("#projects .card3_img3")

//card 1, showing the letter one by one , over the course of 3.5 seconds
card1.addEventListener("mouseover", () => {
    word_technologies.children[0].style.display = "inline-block"
    setTimeout(() => {
        word_technologies.children[1].style.display = "inline-block"
    }, 150);
    setTimeout(() => {
        word_technologies.children[2].style.display = "inline-block"
    }, 300);
    setTimeout(() => {
        word_technologies.children[3].style.display = "inline-block"
    }, 450);
    setTimeout(() => {
        word_technologies.children[4].style.display = "inline-block"
    }, 600);
    setTimeout(() => {
        word_technologies.children[5].style.display = "inline-block"
    }, 750);
    setTimeout(() => {
        word_technologies.children[6].style.display = "inline-block"
    }, 900);
    setTimeout(() => {
        word_technologies.children[7].style.display = "inline-block"
    }, 1050);
    setTimeout(() => {
        word_technologies.children[8].style.display = "inline-block"
    }, 1250);
    setTimeout(() => {
        word_technologies.children[9].style.display = "inline-block"
    }, 1400);
    setTimeout(() => {
        word_technologies.children[10].style.display = "inline-block"
    }, 1550);
    setTimeout(() => {
        word_technologies.children[11].style.display = "inline-block"
    }, 1700);
    setTimeout(() => {
        word_technologies.children[12].style.display = "inline-block"
    }, 1850);
    setTimeout(() => {
        word_technologies.children[13].style.display = "inline-block"
    }, 2000);
    setTimeout(() => {
        word_technologies.children[14].style.display = "inline-block"
    }, 2150);
    setTimeout(() => {
        word_technologies.children[15].style.display = "inline-block"
    }, 2300);
    setTimeout(() => {
        card1_img1.style.display = "inline-block"
    }, 2600);
    setTimeout(() => {
        card1_img2.style.display = "inline-block"
    }, 3000);
    setTimeout(() => {
        card1_img3.style.display = "inline-block"
    }, 3400);
})

card1.addEventListener("mouseleave", () => {

    word_technologies.children[0].style.display = "none"
    setTimeout(() => {
        word_technologies.children[1].style.display = "none"
    }, 50);
    setTimeout(() => {
        word_technologies.children[2].style.display = "none"
    }, 100);
    setTimeout(() => {
        word_technologies.children[3].style.display = "none"
    }, 150);
    setTimeout(() => {
        word_technologies.children[4].style.display = "none"
    }, 200);
    setTimeout(() => {
        word_technologies.children[5].style.display = "none"
    }, 250);
    setTimeout(() => {
        word_technologies.children[6].style.display = "none"
    }, 300);
    setTimeout(() => {
        word_technologies.children[7].style.display = "none"
    }, 450);
    setTimeout(() => {
        word_technologies.children[8].style.display = "none"
    }, 500);
    setTimeout(() => {
        word_technologies.children[9].style.display = "none"
    }, 550);
    setTimeout(() => {
        word_technologies.children[10].style.display = "none"
    }, 600);
    setTimeout(() => {
        word_technologies.children[11].style.display = "none"
    }, 650);
    setTimeout(() => {
        word_technologies.children[12].style.display = "none"
    }, 700);
    setTimeout(() => {
        word_technologies.children[13].style.display = "none"
    }, 750);
    setTimeout(() => {
        word_technologies.children[14].style.display = "none"
    }, 800);
    setTimeout(() => {
        word_technologies.children[15].style.display = "none"
    }, 850);
    setTimeout(() => {
        card1_img1.style.display = "none"
    }, 900);
    setTimeout(() => {
        card1_img2.style.display = "none"
    }, 925);
    setTimeout(() => {
        card1_img3.style.display = "none"
    }, 950);
})

//card 2
card2.addEventListener("mouseover", () => {
    word_technologies2.children[0].style.display = "inline-block"
    setTimeout(() => {
        word_technologies2.children[1].style.display = "inline-block"
    }, 150);
    setTimeout(() => {
        word_technologies2.children[2].style.display = "inline-block"
    }, 300);
    setTimeout(() => {
        word_technologies2.children[3].style.display = "inline-block"
    }, 450);
    setTimeout(() => {
        word_technologies2.children[4].style.display = "inline-block"
    }, 600);
    setTimeout(() => {
        word_technologies2.children[5].style.display = "inline-block"
    }, 750);
    setTimeout(() => {
        word_technologies2.children[6].style.display = "inline-block"
    }, 900);
    setTimeout(() => {
        word_technologies2.children[7].style.display = "inline-block"
    }, 1050);
    setTimeout(() => {
        word_technologies2.children[8].style.display = "inline-block"
    }, 1250);
    setTimeout(() => {
        word_technologies2.children[9].style.display = "inline-block"
    }, 1400);
    setTimeout(() => {
        word_technologies2.children[10].style.display = "inline-block"
    }, 1550);
    setTimeout(() => {
        word_technologies2.children[11].style.display = "inline-block"
    }, 1700);
    setTimeout(() => {
        word_technologies2.children[12].style.display = "inline-block"
    }, 1850);
    setTimeout(() => {
        word_technologies2.children[13].style.display = "inline-block"
    }, 2000);
    setTimeout(() => {
        word_technologies2.children[14].style.display = "inline-block"
    }, 2150);
    setTimeout(() => {
        word_technologies2.children[15].style.display = "inline-block"
    }, 2300);
    setTimeout(() => {
        card2_img1.style.display = "inline-block"
    }, 2600);
    setTimeout(() => {
        card2_img2.style.display = "inline-block"
    }, 3000);
    setTimeout(() => {
        card2_img3.style.display = "inline-block"
    }, 3400);
})

card2.addEventListener("mouseleave", () => {

    word_technologies2.children[0].style.display = "none"
    setTimeout(() => {
        word_technologies2.children[1].style.display = "none"
    }, 50);
    setTimeout(() => {
        word_technologies2.children[2].style.display = "none"
    }, 100);
    setTimeout(() => {
        word_technologies2.children[3].style.display = "none"
    }, 150);
    setTimeout(() => {
        word_technologies2.children[4].style.display = "none"
    }, 200);
    setTimeout(() => {
        word_technologies2.children[5].style.display = "none"
    }, 250);
    setTimeout(() => {
        word_technologies2.children[6].style.display = "none"
    }, 300);
    setTimeout(() => {
        word_technologies2.children[7].style.display = "none"
    }, 450);
    setTimeout(() => {
        word_technologies2.children[8].style.display = "none"
    }, 500);
    setTimeout(() => {
        word_technologies2.children[9].style.display = "none"
    }, 550);
    setTimeout(() => {
        word_technologies2.children[10].style.display = "none"
    }, 600);
    setTimeout(() => {
        word_technologies2.children[11].style.display = "none"
    }, 650);
    setTimeout(() => {
        word_technologies2.children[12].style.display = "none"
    }, 700);
    setTimeout(() => {
        word_technologies2.children[13].style.display = "none"
    }, 750);
    setTimeout(() => {
        word_technologies2.children[14].style.display = "none"
    }, 800);
    setTimeout(() => {
        word_technologies2.children[15].style.display = "none"
    }, 850);
    setTimeout(() => {
        card2_img1.style.display = "none"
    }, 900);
    setTimeout(() => {
        card2_img2.style.display = "none"
    }, 925);
    setTimeout(() => {
        card2_img3.style.display = "none"
    }, 950);
})

//card 3
card3.addEventListener("mouseover", () => {
    word_technologies3.children[0].style.display = "inline-block"
    setTimeout(() => {
        word_technologies3.children[1].style.display = "inline-block"
    }, 150);
    setTimeout(() => {
        word_technologies3.children[2].style.display = "inline-block"
    }, 300);
    setTimeout(() => {
        word_technologies3.children[3].style.display = "inline-block"
    }, 450);
    setTimeout(() => {
        word_technologies3.children[4].style.display = "inline-block"
    }, 600);
    setTimeout(() => {
        word_technologies3.children[5].style.display = "inline-block"
    }, 750);
    setTimeout(() => {
        word_technologies3.children[6].style.display = "inline-block"
    }, 900);
    setTimeout(() => {
        word_technologies3.children[7].style.display = "inline-block"
    }, 1050);
    setTimeout(() => {
        word_technologies3.children[8].style.display = "inline-block"
    }, 1250);
    setTimeout(() => {
        word_technologies3.children[9].style.display = "inline-block"
    }, 1400);
    setTimeout(() => {
        word_technologies3.children[10].style.display = "inline-block"
    }, 1550);
    setTimeout(() => {
        word_technologies3.children[11].style.display = "inline-block"
    }, 1700);
    setTimeout(() => {
        word_technologies3.children[12].style.display = "inline-block"
    }, 1850);
    setTimeout(() => {
        word_technologies3.children[13].style.display = "inline-block"
    }, 2000);
    setTimeout(() => {
        word_technologies3.children[14].style.display = "inline-block"
    }, 2150);
    setTimeout(() => {
        word_technologies3.children[15].style.display = "inline-block"
    }, 2300);
    setTimeout(() => {
        card3_img1.style.display = "inline-block"
    }, 2600);
    setTimeout(() => {
        card3_img2.style.display = "inline-block"
    }, 3000);
    setTimeout(() => {
        card3_img3.style.display = "inline-block"
    }, 3400);
})

card3.addEventListener("mouseleave", () => {

    word_technologies3.children[0].style.display = "none"
    setTimeout(() => {
        word_technologies3.children[1].style.display = "none"
    }, 50);
    setTimeout(() => {
        word_technologies3.children[2].style.display = "none"
    }, 100);
    setTimeout(() => {
        word_technologies3.children[3].style.display = "none"
    }, 150);
    setTimeout(() => {
        word_technologies3.children[4].style.display = "none"
    }, 200);
    setTimeout(() => {
        word_technologies3.children[5].style.display = "none"
    }, 250);
    setTimeout(() => {
        word_technologies3.children[6].style.display = "none"
    }, 300);
    setTimeout(() => {
        word_technologies3.children[7].style.display = "none"
    }, 450);
    setTimeout(() => {
        word_technologies3.children[8].style.display = "none"
    }, 500);
    setTimeout(() => {
        word_technologies3.children[9].style.display = "none"
    }, 550);
    setTimeout(() => {
        word_technologies3.children[10].style.display = "none"
    }, 600);
    setTimeout(() => {
        word_technologies3.children[11].style.display = "none"
    }, 650);
    setTimeout(() => {
        word_technologies3.children[12].style.display = "none"
    }, 700);
    setTimeout(() => {
        word_technologies3.children[13].style.display = "none"
    }, 750);
    setTimeout(() => {
        word_technologies3.children[14].style.display = "none"
    }, 800);
    setTimeout(() => {
        word_technologies3.children[15].style.display = "none"
    }, 850);
    setTimeout(() => {
        card3_img1.style.display = "none"
    }, 900);
    setTimeout(() => {
        card3_img2.style.display = "none"
    }, 925);
    setTimeout(() => {
        card3_img3.style.display = "none"
    }, 950);
})



project2_container.addEventListener("1mouseover", () => {
...
btn_accordion1.addEventListener("click", () => {
    if (btn_accordion1.innerHTML == "Show") {
        btn_accordion1.innerHTML = "hide"
    } else {
        btn_accordion1.innerHTML = "Show"
    }
})

btn_accordion2.addEventListener("click", () => {
    if (btn_accordion2.innerHTML == "hide") {
        btn_accordion2.innerHTML = "show"
    } else {
        btn_accordion2.innerHTML = "hide"
    }
})
...
const h1_wrapper = document.querySelector("#interests .h1-wrapper")
...
function test1() {
    ...
    interests_inner.style.backgroundImage = "url('https://i.ibb.co/wNY9yk5/sports.png')" //"url('/assets/img/css3_img.png')"
...
function testt() {
    ...
    interests_inner.style.backgroundImage = "" //try none?
...
interests_inner.children[1].addEventListener("mouseover", () => {
    ...
    interests_inner.children[1].style.marginLeft = "25px"
    interests_inner.style.backgroundImage = "url('https://i.ibb.co/vw4mkLD/books.png')"
    interests_inner.style.backgroundRepeat = "no-repeat"
    interests_inner.style.backgroundSize = "cover"
    interests_inner.style.backgroundPosition = "center center"
    interests_inner.style.padding = "100px"
...
interests_inner.children[1].addEventListener("mouseleave", () => {
    interests_inner.children[1].style.marginLeft = "" // the 2 div
...
interests_inner.children[2].addEventListener("mouseover", () => {
    ...
    interests_inner.style.backgroundImage = "url('https://i.ibb.co/jJpCKHm/travel.png')"
    interests_inner.style.backgroundRepeat = "no-repeat"
    interests_inner.style.backgroundSize = "cover"
    interests_inner.style.backgroundPosition = "center center"
    interests_inner.style.padding = "100px"
...
//inner section
interests_inner.addEventListener("mouseover", functest)

function functest() {
    interests_inner.style.transition = "all ease 2s"
    h1_wrapper.style.transition = "all ease 2s"
    // interests_inner.style.backgroundImage = "url('https://i.ibb.co/NZ7x99h/interests-bg.png')" //css
    interests_inner.style.backgroundRepeat = "no-repeat"
    interests_inner.style.backgroundSize = "cover"
    interests_inner.style.backgroundPosition = "center center"
    interests_inner.style.padding = "200px"
    h1_wrapper.style.marginBottom = "70px"
    h1_wrapper.style.marginTop = "-30px"
...
interests_inner.addEventListener("mouseleave", () => {
    interests_inner.style.transition = "all ease 2s"
    // setTimeout(() => {
    //     interests_inner.style.backgroundImage = "none"
    // }, 2000);
    interests_inner.style.backgroundRepeat = ""
    interests_inner.style.backgroundSize = ""
    interests_inner.style.backgroundPosition = ""
    ...
    //the h1 wrapper margin
    h1_wrapper.style.marginBottom = "20px"
    h1_wrapper.style.marginTop = ""
})
...
const hidden_div_proj1 = document.querySelector("#projects .hidden_div_proj1")
const proj1_btn1 = document.querySelector("#projects .row0 .btn-1")
const hidden_div_proj2 = document.querySelector("#projects .hidden_div_proj2")
const proj1_btn2 = document.querySelector("#projects .row0 .btn-2")

proj1_btn1.addEventListener("mouseover", () => {
    proj1_btn1.style.transition = "all ease 4s"
    hidden_div_proj1.style.transition = "all ease 4s"
    hidden_div_proj1.style.display = "block"
    hidden_div_proj1.style.width = "700px"
    hidden_div_proj1.style.height = "600px"
    proj1_btn2.style.transition = "all ease 4s"
    proj1_btn2.style.marginLeft = "200px"

})

proj1_btn1.addEventListener("mouseleave", () => {
    proj1_btn1.style.transition = "all ease 4s"
    hidden_div_proj1.style.transition = "all ease 4s"
    hidden_div_proj1.style.display = ""
    hidden_div_proj1.style.width = "0px"
    hidden_div_proj1.style.height = "0px"
    proj1_btn2.style.transition = "all ease 4s"
    proj1_btn2.style.marginLeft = ""

})


proj1_btn2.addEventListener("mouseover", () => {
    proj1_btn2.style.transition = "all ease 4s"
    hidden_div_proj2.style.transition = "all ease 4s"
    hidden_div_proj2.style.display = "block"
    hidden_div_proj2.style.width = "700px"
    hidden_div_proj2.style.height = "650px"

})

proj1_btn2.addEventListener("mouseleave", () => {
    proj1_btn2.style.transition = "all ease 4s"
    hidden_div_proj2.style.transition = "all ease 4s"
    hidden_div_proj2.style.display = ""
    hidden_div_proj2.style.width = "0px"
    hidden_div_proj2.style.height = "0px"
})

// <!-- the images didnt want to display , because in github , I didnt add them to the folder assets/img , lol hahahahahaha -->